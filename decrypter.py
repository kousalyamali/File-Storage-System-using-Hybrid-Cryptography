...
def Algo1(key):
	...
	for line in target_file:
		secret_data = secret_data + line.decode('unicode_escape')
...
def Algo1_extented(filename, key1, key2):
	...
	secret_data = f.decrypt(line, 50000)
...
def decrypter():
	...
	for line in public_key:
		key_1 = key_1 + line.decode('unicode_escape')
	public_key.close()
	...
	# download from firebase and make it available in encrypted folder
