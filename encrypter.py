...
def Algo1(data, key):
	...
	secret_data = f.encrypt(str.encode(data))
...
def Algo1_extented(filename, key1, key2):
	...
	raw = ""
	for line in file:
		raw = raw + line.decode('unicode_escape')
	secret_data = f.encrypt(str.encode(raw))
	target_file.write(secret_data)
	file.close()
	target_file.close()
...
def encrypter():
	...
	secret_information = (key_1_1.decode('unicode_escape'))+":::::"+(key_1_2.decode('unicode_escape'))+":::::"+(key_2.decode('unicode_escape'))+":::::"+(key_3.decode('unicode_escape'))+":::::"+(key_4.decode('unicode_escape'))+":::::"+(nonce12.decode('unicode_escape'))+":::::"+(nonce13.decode('unicode_escape'))
